...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $update_sql = "UPDATE laporan SET pesan = '$new_status' WHERE id = $id_pengaduan";
        ...
        <?php while ($data = mysqli_fetch_assoc($result)) { ?>
            <tr>
                ...
                <td>
                    ...
                    <!-- Formulir untuk mengubah status -->
<form action="pesan_piber.php" method="post">
    <input type="hidden" name="id_pengaduan" value="<?= $data['id']; ?>">
    <input type="text" name="new_status" autocomplete="off" placeholder="Masukkan pesan baru">
    <button type="submit">Ubah Pesan</button>
</form>
