    ...
    <main class="container mx-auto py-8">
        <section class="hero bg-gray-100 py-20">
            <div class="text-center">
                <h2 class="text-3xl font-bold mb-2">Laporkan Permasalahan Anda</h2>
                <p class="text-gray-700 mb-8">Layanan pengaduan masyarakat untuk perbaikan pelayanan publik.</p>
                <a href="add_complaint.php" class="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded">Ajukan Pengaduan</a>
            </div>
        </section>
            ...
            <div class="text-center">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div class="feature">
                        ...
                        <h3 class="text-xl font-semibold mb-2">Riwayat Pengaduan</h3>
                        <p class="text-gray-700">Lihat riwayat pengaduan Anda beserta statusnya.</p><br>
                        <a href="riwayat.php" class="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded">Riwayat Pengaduan</a>
                    </div>
                    <div class="feature">
                        <i class="fas fa-info-circle text-3xl mb-4"></i>
                        <h3 class="text-xl font-semibold mb-2">Solusi dan Tanggapan</h3>
                        <p class="text-gray-700">Lihat solusi dan tanggapan yang telah diberikan terhadap pengaduan yang diajukan.</p><br>
                        <a href="solusi.php" class="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded">Solusi dan Tanggapan Pengaduan</a>
                    </div>
                    </div>
                </div>
            </div>
