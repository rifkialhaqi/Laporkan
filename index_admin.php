        ...
        <div class="container mx-auto flex items-center justify-between px-4">
            ...
            <nav>
                <ul class="flex space-x-4">
                    <li><a href="inde_admin.php" class="hover:underline">Beranda</a></li>
            ...
            <div class="text-center">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div class="feature">
                        ...
                        <h3 class="text-xl font-semibold mb-2">Status Pengaduan</h3>
                        <p class="text-gray-700">Lihat riwayat pengaduan Anda beserta statusnya.</p><br>
                        <a href="riwayat_admin.php" class="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded">Status Pengaduan</a>
                    </div>
                </div>
            </div>
        </section>
